...
<div className="img-grid">
  <div className="img-item">
    ![Matching "Code is Life" shirts indoors](images/2025-03-20-microsoft-mvp-catchup-wellington-1.jpg)
  </div>
  <div className="img-item">
    ![Group holding books at tech event](images/2025-03-20-microsoft-mvp-catchup-wellington-2.jpg) 
  </div>
  <div className="img-item">
    ![Book on ASP.NET Core 8 displayed](images/2025-03-20-microsoft-mvp-catchup-wellington-3.jpg)
  </div>
</div>
